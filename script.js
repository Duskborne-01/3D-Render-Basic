...
function perspective(p) {
  ...
  return [x / (z + perspective), y / (z + perspective)];
}
...
function rotateX(p, r) {
  ...
  return [cos(r) * x - sin(r) * z, y, sin(r) * x + cos(r) * z];
}
...
function rotateY(p, r) {
  ...
  return [x, cos(r) * y - sin(r) * z, sin(r) * y + cos(r) * z];
}
...
function main() {
  ...
  text(
    "FPS " + fps + "    " + Math.floor((fps * 100) / 70) + " % do fps completo",
    10,
    20,
  );
